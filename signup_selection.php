...
<html lang="en">
<head>
  <link rel="stylesheet" href="assets/signup_selection.css" />
...
<body>
  <div class="box col-xs-10 col-xs-offset-1 ">
          	...
          	<div class="midBox" style="padding-top:50px;">
          		<a href="signup_client.php" class="btn btn-primary btn-lg">Trainer</a>
          		<br/>
          		<br/>
          		<a href="signup_client.php" class="btn btn-primary btn-lg">Member</a>
