...
$aa= "SELECT * FROM joblist WHERE employer = '$fullname' ";
...
<li class="selected"><a href="jobhistory_client.php">Jobs History</a></li>
...
<?php if(mysqli_num_rows($bb) > 0) {
  echo '<table style="border:1px solid black">';
    ...
    while($row = mysqli_fetch_array($bb)){
      echo '<form><tbody><tr>';
      echo '<td>'.'<a href="editjob.php?id='.$row["jobID"].'">'. $row["jobID"].'</a>'. '</td>';
